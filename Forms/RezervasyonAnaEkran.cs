...
{
    public partial class RezervasyonAnaEkran : Form
    {
        public RezervasyonAnaEkran()
        {
            InitializeComponent();
        }
        ...
        private void RezervasyonAnaEkran_Load(object sender, EventArgs e)
        {
            seferListesi();
        }
        ...
        private void button26_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                komut.Parameters.AddWithValue("@p5", "ÖDENMEDİ");
                komut.ExecuteNonQuery();
                baglanti.Close();

                MessageBox.Show("BİLET REZERVASYONU BAŞARILI ŞEKİLDE ALINDI.", "Bilgi", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        }
