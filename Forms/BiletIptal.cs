...
namespace BusTicketProject
{
    public partial class BiletIptal : Form
    {
        ...
        SqlConnection baglanti = new SqlConnection(@"Data Source=(LOCAL);Initial Catalog=BusTicket;Integrated Security=True");
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (textBox1.Text != String.Empty)
            {
                ...
                if (radioButton1.Checked == true) {
                    MessageBox.Show("Bilet iptali başarılı şekilde kaydedildi Ücretiniz Nakit olarak iade edilecektir.", "Bilgi", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
                if (radioButton2.Checked == true) {
                    MessageBox.Show("Bilet iptali başarılı şekilde kaydedildi Ücretiniz EFT yoluyla iade edilecektir.", "Bilgi", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
